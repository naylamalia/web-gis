...
class UpdateAnggotaKeluargaRequest extends FormRequest
{
    ...
    {
        $id = $this->route('anggota'); // pastikan sesuai dengan parameter route

        return [
            'keluarga_id' => 'required|exists:keluargas,id',
            'nik' => 'required|string|unique:anggota_keluargas,nik,' . $id,
